...
function readIdentity(path: string): M4TargetFileIdentity | null {
  try {
...
function hasExactGitTrackedPath(root: string, path: string): boolean {
  try {
